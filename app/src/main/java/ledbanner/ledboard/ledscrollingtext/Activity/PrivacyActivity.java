...
public class PrivacyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((AppCompatTextView) findViewById(R.id.tvTitle)).setText(getString(R.string.privacy_policy));

        tvPrivacy = findViewById(R.id.tvPrivacy);
        String bodyData = "<body>\n" +
                "    <strong>Privacy Policy</strong> <p>\n" +
                "                   built the LED Scroller Text app as\n" +
                ...
                "                  LED Scroller Text unless otherwise defined in this Privacy Policy.\n" +
                ...
                "                  Privacy Policy, do not hesitate to contact me at askon@gmail.com.</p>\n" +
                "    </body>";
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            tvPrivacy.setText(Html.fromHtml(bodyData, Html.FROM_HTML_MODE_LEGACY));
        } else {
            tvPrivacy.setText(Html.fromHtml(bodyData));
        }
    }
}